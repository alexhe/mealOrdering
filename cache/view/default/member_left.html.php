<div class="member_left">
    	<div class="memver_L_idBox">
        	<div class="memver_L_idPhoto"><img src="/mealOrdering/webcss/default/images/sir.gif"></div>
        	<div class="memver_L_idName">您好，<span class="txt_orangeB"><?php echo $this_login_user->uname;?></span> !</div>
            <div class="memver_L_idVIP">等级：<img src="/mealOrdering/webcss/default/images/vip<?php echo $loginuser_level;?>.png" align="absmiddle"></div>
    	...
    	<div class="memver_L_top"><img src="/mealOrdering/webcss/default/images/title_member.gif"></div>
