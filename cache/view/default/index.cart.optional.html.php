...
<div class="main">
	...
	<div class="div_3" id="id_list_0">
		...
		<div class="x_list1"><div class="x_col1"><?php echo $cart['index'];?></div><div class="x_col2 main_w4">
			...
			<li class="x_menu" style="background:url(<?php echo $cart_list['menu']['id_'.$menu]['menu_pic_small'];?>)" onmouseover="kj.show(kj.obj('img',this));"  onmouseout="kj.hide(kj.obj('img',this));" onclick="thisjs.cart_del(this , 0 , <?php echo $cart_list['menu']['id_'.$menu]['menu_id'];?> , '<?php echo $cart_list['menu']['id_'.$menu]['menu_price'];?>' )" title="<?php echo $cart_list['menu']['id_'.$menu]['menu_title'];?>"><img src="/mealOrdering/webcss/default/images/btn_del.gif" style="display:none"></li>
			<li class="x_plus">&nbsp;</li>
			<?php }?>
