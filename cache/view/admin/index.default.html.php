...
<div class="header">
	...
	<div class="x_info a_1" id="id_info_div">
		...
		<span style="float:left"><img src="/mealOrdering/webcss/admin/images/pic_1.gif"></span>
		...
		<span style="float:left"><img src="/mealOrdering/webcss/admin/images/pic_2.gif"></span><span style="float:left">&nbsp;<a href="javascript:thisjs.klkkdj_open('开店向导','app_act=guide&app=service');">开店向导</a>&nbsp;&nbsp;</span>
		<?php }?>
		<?php if($this_limit->chk_act("msg",'index','index')){?>
		<span style="float:left"><img src="/mealOrdering/webcss/admin/images/pic_3.gif"></span><span style="float:left">&nbsp;<a href="javascript:thisjs.klkkdj_open('意见反馈','app_act=msg&app=service');">意见反馈</a>&nbsp;&nbsp;</span>
		<?php }?>
		...
		<a href="http://localhost/mealOrdering/common.php?app=sys&app_act=login.out" style="color:#ffffff" target="_top">退出系统</a>
		</li>
	</div>
...
<script src="/mealOrdering/webcss/common/js/kj.progress.js"></script>
<script>
