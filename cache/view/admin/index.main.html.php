...
<script src="/mealOrdering/webcss/common/js/kj.draw.js"></script>
<script src="/mealOrdering/webcss/common/js/kj.chart.js"></script>
<style>
...
<table width="100%" style="margin:0px;padding:0px;">
	<tr><td width="137px">&nbsp;</td><td style="padding-top:20px" valign="top">
		...
		<div class="main_box1">
			...
			<li class="x_line">&nbsp;</li>
			<li><b>系统版本信息</b><br>系统名称：<a href="jiacan.me">家餐网</a><br>当前版本：1.0正式版<span id="id_version_new" style="color:#ff8800"></span><br>官方账号：<?php echo $version_info['web_uname'];?>&nbsp;&nbsp;<span style="color:#ff8800;cursor:pointer" id="id_new_msg" onclick="thisjs.ucenter();"></span></li>
		</div>
		</td><td valign="top">
