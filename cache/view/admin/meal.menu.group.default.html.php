...
<div class="pMain" id="id_main">
	...
	<li style="display:none" id="id_layer_default">
		...
		<span class="xx_1"><input type="text" name="group_name[]" value="" class='pTxt1 pTxtL150'></span><span class="xx_1"><!--<a href="javascript:kj.layer.add('#id_layer_default',50);"><img src="/mealOrdering/webcss/admin/images/add.gif"></a>&nbsp;&nbsp;--><a href="javascript:kj.layer.remove('id_layer_default');"><img src="/mealOrdering/webcss/admin/images/romove.gif"></a></span></li>
	...
	<li id="id_layer_<?php echo $item['group_id'];?>">
		...
		<span class="xx_1"><input type="text" name="group_name[]" value="<?php echo $item['group_name'];?>" class='pTxt1 pTxtL150'></span><span class="xx_1"><!--<a href="javascript:kj.layer.add('#id_layer_<?php echo $item['group_id'];?>',50);"><img src="/mealOrdering/webcss/admin/images/add.gif"></a>&nbsp;&nbsp;--><a href="javascript:kj.layer.remove('id_layer_<?php echo $item['group_id'];?>');"><img src="/mealOrdering/webcss/admin/images/romove.gif"></a><!--&nbsp;&nbsp;<a href="javascript:kj.layer.move(<?php echo $item['group_id'];?>);">移</a>--></span></li>
	<?php }?>
	</div>
	<div class="pLayerAdd"><a href="javascript:kj.layer.add();"><img src="/mealOrdering/webcss/admin/images/add.gif"> 添加新组</a></div>
</div>
